...
class CheckoutAreaSimulator {
	...
	private void doSimulation()
	{
  		...
  		for (int currentTime = 0; currentTime < simulationTime; currentTime++) 
  		{
    		...
    		// free any cashiers that aren't busy anymore
    		...
    		// If more customers need help check if any free cashiers
  			int maxFor;
  			...
  			{
  				maxFor = checkoutarea.numWaitingCustomers();
  			}
